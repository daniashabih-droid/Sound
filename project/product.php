			...
			<div class="row row--grid">
				...
				<div class="col-12">
					<ul class="breadcrumb">
						...
						<li class="breadcrumb__item"><a href="store.html.htm">Store</a></li>
					...
					<div class="store-item">
						...
						<div class="store-item__description">
							...
							<div class="article__content">
								<h4>About Headphones ZR-991</h4>

								<span class="article__price">$199</span>

								<p>There are many <b>variations</b> of passages of Lorem Ipsum available, but the majority have <a href="#">suffered</a> alteration in some form, by injected humour, or randomised words which don't look even slightly believable. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages.</p>
								...
								<a href="#" class="article__buy">Add to cart</a>
